...
- The ten supplementary names are CI-bound scenarios: the first five exercise Doom-owned overlay states (including system font-scale 2.0 and landscape), the sixth is the scrollable MainActivity build-footer screen after overlay removal, and names seven through ten show the timer expanded, collapsed, at 2.0 font scale, and in landscape. They remain synthetic UI evidence and are not claimed as executed until exact-head CI uploads the manifest.
