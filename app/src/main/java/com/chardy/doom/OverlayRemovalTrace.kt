...
internal enum class RemovalTraceMark {
    ...
    SERVICE_CONNECTED_RESET, SERVICE_INTERRUPTED, SERVICE_UNBOUND, SERVICE_DESTROYED, USER_DEBUG,
...
internal enum class RemovalTraceAction {
    NONE, BYPASS, RESET_OUTSIDE, COMPLETE, PRESERVE_REPORT, OPEN_DEBUG, NAVIGATE_MESSAGES, HOME
}
...
internal class RemovalTraceRecorder(
    ...
    companion object {
        ...
        private val causeMarks: Set<RemovalTraceMark> = EnumSet.of(
            ...
            RemovalTraceMark.USER_HOME, RemovalTraceMark.USER_DEBUG, RemovalTraceMark.APP_RETURN,
