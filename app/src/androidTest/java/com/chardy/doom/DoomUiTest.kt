...
class DoomUiTest {
 ...
 @Test fun customCancelDismissesWithoutSaving(){
  ...
  click("Cancel");visible("10s");rule.scenario.recreate();visible("10s");scrollTo("1m")
 }
